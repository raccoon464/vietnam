...
InlineKeyboardButtonUrl = namedtuple('InlineKeyboardButton', ['text', 'url'])
...
class InlineKeyboardPaginator:
    ...
    def add_after_url(self, *inline_buttons):
        self._keyboard_after.append(_buttons_to_dict_url(inline_buttons))
...
def _buttons_to_dict_url(buttons):
    return [
        {
            'text': button.text,
            'url': button.url,
